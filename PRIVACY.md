...
LLM extraction is disabled by default. Enabling a remote provider can send a bounded excerpt of source text to that provider. Maintainers must review provider terms and privacy controls first. No visitor data is sent to a model. VLM and face recognition are disabled.
