...
Initial private evaluation build: strict provenance model, bounded configured-source pipeline, fail-closed publication gates, review/hold CLI, source revision history, deterministic static evidence dashboard, contextual chart filtering, safe downloads, policy documents, fixture tests, CI and manual update workflow.

Production data initialized empty. Original Wb-Food-Safety-Tracker.html retained unchanged as a visual reference. No broad ingestion, paid model calls, models, analytics or public deployment.
# 0.3.0 — Phase 1 on develop (not yet production)
