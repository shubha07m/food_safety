...
GENERATED = (
    "data/events.json", "data/events.csv", "data/events.csv.metadata.json",
    "data/status.json", "data/retired.json", "data/source_checks.json",
    "data/pandals.json", "data/puja_refresh.json",
    "site/data/events.json", "site/data/events.csv", "site/data/events.csv.metadata.json",
    "site/data/aggregates.json", "site/data/locations.json", "site/data/retired.json",
    "site/data/lifecycle.json", "site/data/compliance.json", "site/data/pandals.json",
    "site/data/places.json", "site/status.json", "site/repository.json",
    "site/policies/disclaimer.html", "site/policies/methodology.html",
    "site/policies/corrections.html", "site/policies/privacy.html",
    "site/policies/sources.html", "site/policies/data_dictionary.html",
